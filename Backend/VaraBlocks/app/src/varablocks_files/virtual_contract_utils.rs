...
// Implement VirtualContractDataFromFrontend, this works to send Virtual Contract to the contract and
// transform data to a new Virtual Contract.
impl From<VirtualContractDataFromFrontend> for VirtualContract {
    fn from(value: VirtualContractDataFromFrontend) -> Self {
        let VirtualContractDataFromFrontend {
            metadata,
            state,
            init_code,
            handle_code,

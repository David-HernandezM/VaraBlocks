...
import { ENABLED_ACTIONS, SUBSCRIPTIONS_CONTRACT, SIGNLESS_STORAGE_KEY } from '@/app/consts'; 
...
export default function useSignlessUtils() {
    ...
    const contractMetadata = ProgramMetadata.from(SUBSCRIPTIONS_CONTRACT.programMetadata);
    const contractId = SUBSCRIPTIONS_CONTRACT.programId;
    const {
        generateNewVoucher,
        voucherExists,
        voucherBalance,
